...
$sa(
    function($) {
                ...
                $sa("#" + modal_id + ".from-right > .modal-content").animate({
                    ...
                    complete: function() {
                        ...
                        if ($sa("#" + modal_id + " #slide_form .u-column1").length == 0) {
                            $sa("#" + modal_id + " #slide_form .woocommerce").css({
                                "width": wc_width
                            });
                        } else {
                            $sa("#" + modal_id + " #slide_form .u-column1, #" + modal_id + " #slide_form .u-column2").css({
                                "width": wc_width
                            });
                        }
                    }
        ...
        $sa(document).on(
            "click", ".smsalert-modal .backtoLogin",
            function() {
        ...
        $sa(document).on(
            "click", ".smsalert-modal .signupbutton",
            function() {
...
$sa(document).on(
    "click", ".from-right > .modal-content > .close,.from-left > .modal-content > .close",
    function() {
